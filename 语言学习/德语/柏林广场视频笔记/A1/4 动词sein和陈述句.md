...
```mermaid
graph TD
    Subject[主语人称] --> Sein{Sein 的变位}

    subgraph 单数 Singular
    Sein -->|ich 我| Bin(bin)
    Sein -->|du 你| Bist(bist)
    Sein -->|er/sie/es 他她它| Ist(ist)
    end

    subgraph 复数 Plural
    Sein -->|wir 我们| Sind_Wir(sind)
    Sein -->|ihr 你们| Seid(seid)
    Sein -->|sie/Sie 他们/您| Sind_Sie(sind)
    end

    style Bin fill:#f9d5e5,stroke:#333,stroke-width:2px
    style Ist fill:#f9d5e5,stroke:#333,stroke-width:2px

...
graph LR
    ...
    Director((强势导演<br>AUS))

    subgraph 变形-第三格-Dativ
    D_Dem[变成 dem]
    D_Dem2[变成 dem]
    D_Der[变成 der]
    D_Den[变成 den]
    ...
    N_Der --> Director --> D_Dem
    N_Das --> Director --> D_Dem2
    N_Die --> Director --> D_Der
    N_Pl  --> Director --> D_Den

    style Director fill:#f96,stroke:#333,stroke-width:2px
    style D_Der fill:#ff9,stroke:#f66,stroke-width:2px,stroke-dasharray: 5, 5
```

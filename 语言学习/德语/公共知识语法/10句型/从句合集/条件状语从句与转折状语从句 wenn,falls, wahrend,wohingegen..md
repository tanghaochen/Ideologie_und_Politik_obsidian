...
Guten Tag! 欢迎来到德语大师的语法课堂！

我完全理解，为了移民在六个月内冲刺到德语 B 2 水平，这就像是一场“德语特种兵”的极限挑战。时间紧、任务重，但请放心，B 2 并没有想象中那么可怕。如果说 A 1-B 1 是教你如何“盖房子”（基础词汇和主谓宾），那么 B 2 和 C 1 的语法就是教你如何在这栋房子里“搞精装修”。

今天我们要攻克的这张图表，正是 B 2/C 1 级别的核心“装修材料”：**条件状语从句 (Konditionalsätze)** 与 **转折状语从句 (Adversativsätze)**。掌握了它们，你和德国外管局（Ausländerbehörde）、房东、面试官的沟通，就会从“小学生级别的蹦词”瞬间升级为“成年人级别的高情商拉扯”。

准备好了吗？我们用最贴近德国生活的场景，把这些语法点一次性拿下！

### 🧠 核心知识图谱：你的大脑导航

在深入细节之前，我们先用一张图表把今天所有的连词归类，在脑海中建立起清晰的逻辑框架：

代码段

```mermaid
flowchart TD
    Root[状语从句 Adverbialsätze] --> Cond[条件状语从句<br>表假设与条件]
    Root --> Adv[转折状语从句<br>表对比与转折]

    Cond --> C_Basic[基础高频]
    C_Basic --> C_wenn["wenn (如果/当...时) - 万能钥匙"]
    C_Basic --> C_falls["falls (如果/万一) - 纯粹条件"]

    Cond --> C_Emph[强调语气]
    C_Emph --> C_nur["nur wenn (只有当...)"]
    C_Emph --> C_sogar["sogar wenn (即使...)"]

    Cond --> C_Formal[书面/行政]
    C_Formal --> C_sofern["sofern / vorausgesetzt, dass (以...为前提)"]

    Cond --> C_NoConj[无连词结构]
    C_NoConj --> C_VerbFirst["动词放句首 (Sollte ich...)"]

    Adv --> A_Basic[对比连词]
    A_Basic --> A_waehrend["während (然而/相对比)"]
    A_Basic --> A_wohingegen["wohingegen (反之/相对的是)"]
```

...
- als
	- (konj) 1 <连接名词、形容词或代词,对有关词作进一步说明;表示身份、性质、作用等>作,作为;当作
	- 2 <表示比较>
	- 3 <连接时间从句>当...的时候
	- 4 <与某些词关联,连接结果从句、原因从句、限制从句等>
	- 5 <表示列举> als da sind (或 ist) 例如,像
...
## wahrend 和 solange 区别

**während** 和 **solange** 都可以用来描述两个同时发生的事情，在中文里经常都被翻译成“当……时”或“在……期间”，但它们的**侧重点、词性以及附带的情感色彩**有很大的区别。

简单来说：**während 强调“重叠”或“对比”，而 solange 强调“时长完全一致”或“条件限制”。**

以下是详细的区别和用法拆解：

### 1. während (强调“同时进行”或“对比”)

**während** 是一个非常多功能的词，它既可以是连词，也可以是介词。

- **作为时间连词（在……期间，一边……一边）：**

    它表示两个动作在同一时间段内发生，**只要有重叠即可**，不要求两个动作同时开始或同时结束。

    - _Beispiel:_ Ich höre Musik, **während** ich Hausaufgaben mache. (我做作业的时候听音乐。)
    - _说明:_ 听音乐和做作业同时在进行，但我不一定是从写作业的第一秒一直听到最后一秒。
- **作为对比连词（然而，而）：**

    这是 **während** 非常常见的一个用法，用来对比两件截然不同的事情（类似于英语的 whereas）。此时与时间无关。

    - _Beispiel:_ Er ist sehr ruhig, **während** sein Bruder sehr gesprächig ist. (他很安静，**而**他的哥哥却很健谈。)
- **作为介词（在……期间）：**

    **während** 可以直接加名词，通常要求接**第二格（Genitiv）**。

    - _Beispiel:_ **Während** des Unterrichts darf man nicht essen. (在上课**期间**不许吃东西。)

### 2. solange (强调“时长一致”和“条件”)

**solange** 只能作为连词（带起从句），意思是“只要……（就）”。

- **强调时间长度完全平行：**

    它强调主句动作和从句动作的**持续时间完全相等**。从句动作什么时候结束，主句动作就什么时候结束。

    - _Beispiel:_ Ich bleibe im Bett, **solange** ich krank bin. (只要我还病着，我就待在床上。)
    - _说明:_ 生病的状态和待在床上的动作是完全同步的。病一好，就不待在床上了。
- **带有强烈的“条件/限制”意味：**

    在日常口语中，它经常被用来设定一个条件（类似于英语的 as long as）。

    - _Beispiel:_ **Solange** du unter meinem Dach lebst, tust du, was ich sage! (**只要**你还住在我的屋檐下，你就要听我的！)
    - _说明:_ 这句话不仅仅是描述时间，更是在下达一个基于特定时间段的条件。

### 总结对比表

为了更直观地理解，你可以参考下表：

|**词汇**|**核心含义 / 侧重点**|**是否要求时长完全一致？**|**附加含义**|**词性**|
|---|---|---|---|---|
|**während**|时间上有重叠 / “在……期间”|**否**。只要有交集即可。|**对比/转折** (然而/而)|连词、介词 (加第二格)|
|**solange**|整个时间段同步 / “只要……”|**是**。同生同灭。|**条件限制** (只要...就)|仅作连词|

**一句话自测：**

如果你想说“他洗澡的时候，我看了会儿书”，用 **während** (时间重叠)。

如果你想说“只要天还下雨，我们就不出门”，用 **solange** (时长一致 + 条件限制)。

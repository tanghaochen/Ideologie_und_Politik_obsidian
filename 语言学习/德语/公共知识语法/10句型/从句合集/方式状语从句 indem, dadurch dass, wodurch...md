...
```mermaid
graph TD
    A[方式状语从句: 解决 '如何办到？'] --> B(indem <br> '通过...方式')
    A --> C(dadurch dass <br> '藉由... / 因为...')
    A --> D(wodurch <br> '从而导致...')
    ...
    C --> C1[特点: 语气更强调，功能更多样]
    C1 --> C2[结构 1: dadurch在主句, dass引导从句 <br>可拆分强调]
    C1 --> C3[结构 2: 可用于表达'原因', 此时不可用indem替换]

    D --> D1[特点: 多米诺骨牌效应]
    D1 --> D2[结构: 指代前一整句话的内容，<br>永远不能放在整句开头！]

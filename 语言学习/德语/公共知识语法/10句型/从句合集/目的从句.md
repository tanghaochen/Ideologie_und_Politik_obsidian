...
# 表目的、表方式的不定式和从句um ..zu, damit, anstatt ., ohne ….

Wunderbar！看来你已经准备好迎接新的挑战了。在通往 B 2 的六个月冲刺里，如果说上一课的“es”是德语里的“万能砖”，那么今天这两张图表里讲的“带 zu 不定式”与“连词从句”的转换，就是你盖起高级德语大厦的“钢筋骨架”。
...
看图一最下面那行小字，这是极其重要的拼写规则：

1. **普通动词**：`zu` 永远放在句末的动词不定式**前面**，两个词分开写。 (例如：_... um Deutsch **zu lernen**._)
2. **可分动词（Trennbare Verben）**：德语的特色来了！`zu` 会像肉饼一样被夹在可分前缀和动词词干**中间**，变成一个长长的单词。
    
    - 看图上的减肥例子：_abnehmen_ (减肥/减轻) 变成 ➡️ _ab**zu**nehmen_。
    - **行政高频词**：_ausfüllen_ (填写表格)。
        - _Ich bin hier, um das Formular aus**zu**füllen._ (我在这里为了填这份表格。)

### 📝 大师的随堂检验

语法听懂了是第一步，肌肉记忆才是通关 B 2 的关键。现在，假设你今天刚搬到德国，要去市政厅（Rathaus）办理登记手续（Anmeldung）。

请运用我们今天学的“分岔路口”思维，判断主语是否一致，并把这两句话翻译成德语交给我批改：

1. **“我去市政厅，为了登记（anmelden）我的新地址。”**
2. **“我给我太太翻译了这份租房合同（der Mietvertrag），为了她能看懂（verstehen）。”**

大胆试着造句吧！错得越多，学得越快！翻译好了发给我。

...
#### 2. 搭配抽象名词 (主句中含有特定的<mark style="background:#d4b106">抽象名词</mark>)
...
graph LR
    ...
    B --> D["Ich habe vor, <b>dass ich</b> mich um die Stelle bewerbe."]
    D --> E[效果：句式臃肿，重复了两次'ich'，听起来像个小学生在汇报。]
    
    C --> F["Ich habe vor, mich um die Stelle <b>zu bewerben</b>.我打算申请这个职位"]
    F --> G[效果：干脆利落，直接切入核心动作，德语母语者最爱的'高效思维'！]
    
    E -.-> H{对比结论}
    G -.-> H
    H --> I[带zu的不定式是'dass从句'的超级瘦身版！]
```
...
```mermaid
graph LR
    subgraph "zu不定式的句尾铁律 (从左到右排列)"
    
    A[第一层：最先放置的成分<br>时间/地点/宾语等] --> B[第二层：小弟动词<br>第二分词/可分前缀/非变位动词]
    B --> C[第三层：大 Boss动词<br>戴上 zu, 永远压轴!]
...
- 对比 带 zu 和不带 zu 的
	- 带 zu: [[zu的不定式#带 zu 的场景|带 zu 的场景]]: 感受客观评价 情况，抽象名词， 延伸动时双动词
	- [[zu的不定式#不带 zu 的不定式|不带 zu 的不定式]]: 情态感官运动动词，四大特殊词

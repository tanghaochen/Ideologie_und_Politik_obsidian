...
前面一句的<font color="#d83931">动词决定了意思所指代的成分</font>


```mermaid
flowchart TD
    Start((遇到实心 es<br>如何查明真身？)) --> Step1{第一步：找准它的老板<br>看 es 所在句子的动词是谁}
    
    Step1 -->|是 sein, werden, bleiben 等系动词| Adj[第二步：身份/状态雷达<br>👉 es 指代前文的形容词]
    Step1 -->|是 wissen, sagen, tun 等认知/行为动词| Satz[第二步：大动作雷达<br>👉 es 指代前文的整件事/整个句子]
    Step1 -->|是 brauchen, mieten, kaufen 等具体实意动词| Nomen[第二步：名词雷达<br>👉 es 指代前文的某个 das-名词]

    Adj --> Exp1(Mein Chef ist pünktlich.<br>Ich bin es auch.)
    Satz --> Exp2(Viele machen Überstunden.<br>Ich tue es auch.)
    Nomen --> Exp3(Wo ist das Zertifikat?<br>Ich brauche es.)
```

### 📡 实义动词，指代中性名词

**🔍 破案线索：当前句子的动词是一个极其具体的、需要“物理接触”或“占有”的<font color="#d83931">实意动词</font>（比如 brauchen, kaufen, mieten, suchen 等）。**
...
**🔍 破案线索：当前句子的动词是连<font color="#d83931">系动词</font>（如 sein 是, werden 变成, bleiben 保持）。**
...
**🔍 破案线索：当前句子的动词是<font color="#d83931">表认知、态度或概括性动作的词</font>（如 wissen 知道, sagen 说, hoffen 希望, tun 做, bedauern 遗憾）。**

...
说的太好了，其实影响更大，有毒的思想不断传承和影响，不只是家庭，朋友，男女，和已经以为自己高认知的人也含有这些思想，深入骨髓，使得人与人之间的关系远离，总是要分个等级找个优越感。
...
1. 第一第二分词区别：
	1. 第一分词只能**表示主动进行的动作。
	2. 如果是被动（比如被烤熟的蛋糕），那是第二分词（Partizip II）的活儿，我们下次再说。
...
```mermaid
flowchart TD
    A[原句: Der Bewerber, der vor der Tür geduldig wartet.那个耐心等待门口的申请者] -->|Step 1: 找到动词并变成第一分词| B(wartet --> wartend)

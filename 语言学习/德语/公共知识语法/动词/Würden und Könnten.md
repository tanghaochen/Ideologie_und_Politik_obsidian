...
```mermaid
graph LR
    Pos1[位置 1:<br>虚拟式动词] --> Pos2[位置 2:<br>主语]
    Pos2 --> Pos3[位置 3:<br>第三格代词]
    Pos3 --> Pos4[位置 4:<br>魔法词]
    Pos4 --> Pos5[位置 5:<br>第四格宾语]
    Pos5 --> Pos6[位置 6:<br>动词原形]
    
    Pos1 -.->|Würden/Könnten| Pos1
    Pos2 -.->|Sie| Pos2
    Pos3 -.->|mir| Pos3
    Pos4 -.->|bitte| Pos4
    Pos5 -.->|den Zucker| Pos5
    Pos6 -.->|geben?| Pos6

    style Pos1 fill:#f9f,stroke:#333
    style Pos6 fill:#f9f,stroke:#333

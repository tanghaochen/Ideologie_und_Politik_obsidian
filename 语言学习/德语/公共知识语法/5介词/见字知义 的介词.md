...
### 📘 德语高级介词 (Hochsprachliche Präpositionen) 笔记

- **zuliebe** (直译：为了……的缘故 | + 第三格 Dativ | ⚠️ 位于名词右边/后置)
    - Er lernt seinen Eltern zuliebe sehr fleißig.
        - 为了父母的缘故，他学习非常刻苦。 _德语意义_: „Weil ich … liebe“ = für … (为了...)
- **zugunsten** (直译：有利于…… / 为了……的利益 | + 第二格 Genitiv | 很少后置，后置时支配第三格)
    - Er verzichtet zugunsten seiner Schwester auf das Geld.
        - 为了他妹妹的利益，他放弃了这笔钱。 _德语意义_: zur Gunst / zum Vorteil von jemandem = weil / damit jemand profitiert (有利于...；反义词：zuungunsten)
**2. 表工具/手段 (Instrumental)**
- **mittels** (直译：借助…… / 通过……手段 | + 第二格 Genitiv)
    - Er konnte mittels eines Drahtes die Tür öffnen.
        - 他能够借助一根铁丝把门打开。 _德语意义_: mit dem Mittel / Instrument (借助于...)
- **mithilfe / mit Hilfe** (直译：在……的帮助下 | + 第二格 Genitiv)
    - Ich konnte den Text nur mithilfe des Wörterbuchs verstehen.
        - 我只能在词典的帮助下理解这段课文。 _德语意义_: mit der Hilfe von etwas (在...帮助下)
- **anhand** (直译：根据…… / 借助…… | + 第二格 Genitiv)
    - Sie können die Entwicklung anhand der Statistik beobachten.
        - 您可以根据统计数据观察其发展情况。 _德语意义_: etwas ist an / in meiner Hand (引申义：根据...，借助...)
**3. 表目的 (Final)**
- **zwecks** (直译：为了……目的 | + 第二格 Genitiv | ⚠️ 通常后面接零冠词的名词)
    - Er treibt zwecks Gewichtsreduktion Sport.
        - 他为了减重而做运动。 _德语意义_: etwas hat den Zweck / das Ziel (为了...目的)
**4. 表反义/对比 (Adversativ)**
- **entgegen** (直译：与……相反 / 违背…… | + 第三格 Dativ | 很少后置)
    - Entgegen deiner Vermutung habe ich alles erledigt.
        - 与你的猜测相反，我已经把一切都处理好了。 _德语意义_: gegen etwas / anders als gedacht, vermutet (与...相反)
**5. 表让步 (Konzessiv)**
- **ungeachtet** (直译：尽管…… / 不顾…… | + 第二格 Genitiv | 很少后置)
    - Ihm wurde ungeachtet seiner langjährigen Mitarbeit gekündigt.
        - 尽管他工作了多年，还是被解雇了。 _德语意义_: ohne darauf zu achten (不顾...，尽管...)
**6. 表方式/替代 (Modal)**
- **seitens / vonseiten** (直译：来自……方面 | + 第二格 Genitiv)
    - Seitens/Vonseiten seines Trainers gab es viel Lob.
        - 来自教练方面（给予了）很多赞扬。 _德语意义_: von einer Seite / Person (表地点，引申义：从...方面来看)
- **anstelle / anstatt** (直译：代替…… / 作为……的替换 | + 第二格 Genitiv)
    - Anstelle eines Autos kaufen wir uns ein Elektrofahrrad.
        - 我们买了一辆电动自行车来代替汽车。 _德语意义_: an der Stelle von etwas anderem (代替...)
**💡 像介词那样使用的固定搭配**
- **im Falle** (直译：在……的情况下 | + 第二格 Genitiv | 表条件)
    - Im Falle eines Unfalls benachrichtigen Sie bitte meine Schwester.
        - 如果发生事故（在发生事故的情况下），请通知我妹妹。 _德语意义_: in dem Fall, dass ... = wenn (如果...)
- **im Gegensatz zu** (直译：与……相对比 | + 第三格 Dativ | 表反义)
    - Im Gegensatz zu dir habe ich alles erledigt.
        - 与你相反，我已经把一切都处理好了。 _德语意义_: im Kontrast zu (与...形成对比)

## 其他

它们大多支配**第二格 (Genitiv)**：

- **方位与空间 (Lokal)** [[语言学习/德语/公共知识语法/介词.md#^f8X9Z1D8|100%]]
    - **inmitten**: 在……当中 (Inmitten der Stadt...)
    - **unweit**: 离……不远 (Unweit des Bahnhofs...)
    - **oberhalb**: 在……上方 (Oberhalb des Waldes...)
    - **unterhalb**: 在……下方 (Unterhalb der Brücke...)
    - **jenseits**: 在……另一边 (Jenseits des Flusses...)
    - **diesseits**: 在……这一边 (Diesseits der Grenze...)
    - **beidseits**: 在……两侧 (Beidseits des Weges...)
- **时间 (Temporal)**
    - **zeit**: 在……一生/期间 (Zeit seines Lebens...)
    - **lang**: 长达…… (_注：支配第四格 Akk.，且放在名词后_，如 jahrelang / einen Monat lang)
    - **anlässlich**: 借……之际 (Anlässlich seines Geburtstags...)
- **原因与条件 (Kausal & Konditional)** [[语言学习/德语/公共知识语法/介词.md#^vy52yBgc|100%]]
    - **aufgrund**: 由于…… (Aufgrund des schlechten Wetters...)
    - **dank**: 多亏了…… (_注：可支配二格或三格_) (Dank seiner Hilfe...)
    - **angesichts**: 鉴于……，面对…… (Angesichts der Krise...)
    - **kraft**: 凭借…… (Kraft meines Amtes...)
    - **mangels**: 因缺乏…… (Mangels Beweisen...)
- **关联与目的 (Bezug & Final)** [[语言学习/德语/公共知识语法/介词.md#^qr6idnCF|100%]]
    - **hinsichtlich**: 关于……，就……而言 (Hinsichtlich der Qualität...)
    - **um ... willen**: 为了……起见 (Um des Friedens willen...)
- **商业与法律条款 **  [[语言学习/德语/公共知识语法/介词.md#^sYY2GQzC|100%]]
    - **zuzüglich** (zzgl.): 加上……，外加 (Zuzüglich der Versandkosten...)
    - **abzüglich** (abzgl.): 扣除…… (Abzüglich der Steuern...)
    - **unbeschadet**: 不损害……，不受……影响 (Unbeschadet seiner Rechte...)
    - **diesbezüglich**: (_注：这是副词/形容词，意为“对此，关于这方面”_) (Ich habe diesbezüglich keine Fragen.)

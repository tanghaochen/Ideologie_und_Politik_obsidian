...
[[语言学习/德语/公共知识语法/从句专题.md#^uBKzxWyF|100%]]

在开始啃语法之前，我们先来建立一个生动的感性认识：**请把“Irgend-”想象成德语世界里的“马赛克滤镜”或者“盲盒”。** 当你在这句话里加上 `irgend-` 时，就意味着：**你不知道具体是谁、不知道具体是哪儿、不知道具体是什么时候，甚至你根本不在乎！它强调的就是一种<font color="#d83931">“不确定性”和“任意性”</font>。** 在某些特定的语境下，它甚至会带有一点点轻视或贬义（比如：“我才不想随便找个什么工作”）。
...
graph TD
    ...
    A[魔法前缀: Irgend-<br>核心要义: 模糊、任意、不确定] --> B(无名词的情况<br>单独作代词或副词)

    A --> C(作为冠词的情况<br>紧跟在名词前面)

    

    B --> B1[指人👤: irgendjemand / irgendwer]

    B --> B2[指物📦: irgendetwas / irgendwas]

    B --> B3[指空间🗺️: irgendwo / irgendwohin...]

    B --> B4[指时间⌚: irgendwann]

    B --> B5[指方式⚙️: irgendwie]

    

    C --> C1[单数名词前: irgend + ein- <br>需按不定冠词变格！]

    C --> C2[复数名词前: irgend + welche <br>需按强变化变格！]

...
首先，我要给你一个大大的肯定：你能敏锐地察觉到被动态（Passiv）有“必须使用”和“主观选择”的区别，这说明你的德语语感已经非常出色了！很多学习者在 B 1 甚至 B 2 阶段，对被动态的理解还只停留在“把主语和宾语互换”的死板公式上。

在德国生活，尤其是面对外管局（Ausländerbehörde）、保险公司或者看合同的时候，被动态简直就是“官方标配”（Behördendeutsch）。如果你想在 6 个月内拿下 B 2，并且在德国顺畅无阻地生活，搞懂被动态的“潜规则”是绝对必要的。

为了帮你彻底理清思路，我们先来看一张“被动态使用决策图”。你可以顺着这张图的逻辑，在脑海里快速判断：
...
### 3. 无人称被动态（Unpersönliches Passiv）：表达群体行为或绝对禁令（必须使用）
